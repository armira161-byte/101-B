        ...
        {step === 'signals' && (
          <div>
            ...
            <div className="flex flex-col gap-3">
              <InfoRow
                title="Направление и цена входа"
                desc="Покупка или продажа с оценкой уверенности от 0 до 100%."
              />
              <InfoRow
                title="Экспирация и выплата"
                desc="Фиксированное время закрытия сделки и процент выплаты — как в реальном контракте бинарного опциона, без стоп-лосса и тейк-профита."
              />
              <InfoRow
                title="Сила сигнала"
        ...
        {step === 'risk' && (
          <div>
            ...
            <div className="rounded-xl border border-accent-700/40 bg-accent-700/10 p-4">
              ...
              <p className="mt-3 text-sm leading-relaxed text-base-300">
                Счёт в этом приложении — демонстрационный: реальные деньги, реальный брокер и реальное
                исполнение сделок отсутствуют, всё исполнение симулируется на исторических/потоковых
                котировках.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-base-300">
                Бинарные опционы для розничных клиентов запрещены или существенно ограничены во многих
                юрисдикциях (в частности, в Евросоюзе/ЕЭЗ с 2018 года и в ряде других стран). Прежде чем
                рассматривать любое использование этих принципов вне демо-режима, самостоятельно уточните
                актуальный регуляторный статус бинарных опционов в вашей юрисдикции.
              </p>
            </div>
