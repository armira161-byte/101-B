...
export function SettingsPanel({ onClose }: { onClose: () => void }) {
  ...
  // РЕФАКТОРИНГ (бинарные опционы, Фаза 5 — risk-of-ruin аудит мартингейла
  // на ЭМПИРИЧЕСКОЙ, а не предполагаемой, точности): winRate/liveCompletedCount
  // берутся из уже накопленной live-статистики резолвнутых демо-сделок
  // текущего инструмента (см. useAnalyticsStore.recomputeStats) — та же
  // самая цифра, что показана в StatusBar.tsx, не отдельно придуманное
  // число.
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4">
          ...
          <Section title="Демо-счёт">
            <div className="flex flex-col gap-3 rounded-lg border border-base-800 bg-base-900 p-3">
              ...
              {demoMartingaleEnabled && (
                <div className="rounded-lg border border-warning-700/40 bg-warning-700/10 p-2.5 text-2xs">
